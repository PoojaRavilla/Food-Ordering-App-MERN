            ...
            <div className="restaurants">
                ...
                <div className='restaurant-item'>
                    <div className="restaurant">
                        ...
                        <div className="restaurant-data">
                            <h6>Spice Hub</h6>
                            <p>Authentic Hyderabadi biryani and spicy tandoori delights.</p>
                            <h5>Rating: <b>4.2/5</b></h5>
                        </div>
                    </div>
                </div>
                ...
                <div className='restaurant-item'>
                    <div className="restaurant">
                        <img src="https://odhi.in/image/cache/catalog/eat/chicken-biryani-odhi-in-eat-online-coimbatore-1000x1000.jpg" alt="" />
                        <div className="restaurant-data">
                            <h6>Udupi Veg Corner</h6>
                            <p>Delicious South Indian tiffins with traditional filter coffee.</p>
                            <h5>Rating: <b>4.0/5</b></h5>
                        </div>
                    </div>
                </div>
                ...
                <div className='restaurant-item'>
                    <div className="restaurant">
                        <img src="https://odhi.in/image/cache/catalog/eat/chicken-biryani-odhi-in-eat-online-coimbatore-1000x1000.jpg" alt="" />
                        <div className="restaurant-data">
                            <h6>Chow Mein Express</h6>
                            <p>Fast Chinese food—Manchurian, noodles, and soups.</p>
                            <h5>Rating: <b>3.8/5</b></h5>
                        </div>
                    </div>
                </div>
                ...
                <div className='restaurant-item'>
                    <div className="restaurant">
                        ...
                        <div className="restaurant-data">
                            <h6>Scoop & Sip</h6>
                            <p>Refreshing milkshakes, smoothies, and artisan ice creams.</p>
                            <h5>Rating: <b>4.5/5</b></h5>
                        </div>
                    </div>
                </div>
                ...
                <div className='restaurant-item'>
                    <div className="restaurant">
                        ...
                        <div className="restaurant-data">
                            <h6>Desi Zaika</h6>
                            <p>Pure vegetarian North Indian thalis and street snacks.</p>
                            <h5>Rating: <b>4.1/5</b></h5>
                        </div>
                    </div>
                </div>
